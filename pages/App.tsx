...
import { GameManager, Player } from "../pebble/prefabs";
...
function App({ race }: { race: Race }) {
  ...
  return loaded ? <GameUI pebbleScene={pebbleScene} /> : <div>Loading...</div>;
